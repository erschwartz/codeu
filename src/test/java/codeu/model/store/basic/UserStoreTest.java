...
public class UserStoreTest {
  ...
  private final User USER_ONE =
      new User(UUID.randomUUID(), "test_username_one", "test_password1", Instant.ofEpochMilli(1000));
  private final User USER_TWO =
      new User(UUID.randomUUID(), "test_username_two", "test_password1", Instant.ofEpochMilli(2000));
  private final User USER_THREE =
      new User(UUID.randomUUID(), "test_username_three", "test_password1", Instant.ofEpochMilli(3000));
